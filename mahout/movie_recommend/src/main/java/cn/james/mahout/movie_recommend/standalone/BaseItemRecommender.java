package cn.james.mahout.movie_recommend.standalone;
...
public class BaseItemRecommender {
    ...
    public static void main(String[] args) throws Exception {
        //准备数据 这里是电影评分数据
        File file = new File("hdfs://node1:9000/movielens/ml-1m/ratings.dat");
//        File file = new File("/Users/jamesxia/Documents/NutStore/大四下/毕设/计软毕设/ml-1m/ratings.dat");
